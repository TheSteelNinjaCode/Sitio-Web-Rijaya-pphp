...
function updateDocumentContent(data) {
  if (data.includes("<!DOCTYPE html>")) {
    ...
    // Hide the document to avoid blinking
    ...
    // Show the document after replacing the content
    ...
    // Hide the body to avoid blinking
    ...
    // Show the body after replacing the content
